...
useEffect(() => {
  ...
  // Handle clear command first before adding any output
  if (cmd === 'clear') {
    // Reset all hint tracking
    setChallenges(prev => prev.map(c => ({ ...c, shownHintIndexes: [] })));
    setTerminalOutput([
      '<span style="color: #4ade80 !important">🥚 Welcome to Reika\'s Domain Egg Hunt! 🥚</span>',
      "",
      '<span style="color: #4ade80 !important">You have 10 minutes to find 5 eggs by solving domain-related challenges.</span>',
  ...
  switch (cmd) {
    ...
    case 'submit':
      ...
      if (matchingChallenge) {
        ...
        addOutput([
          "",
          '<span style= "color: #ff0000ff">❌ Incorrect egg or already submitted.</span>',
          ""
        ]);
        addOutput([
          "",
  ...
  if (hintNum >= 1 && hintNum <= 5) {
    ...
    default:
      addOutput(['<span style= "color: #ff0000ff">❌ Command not found: ${cmd}</span>']),
        "";
      addOutput([
  ...
  <a href="https://github.com/gmdb22" target="_blank" rel="noopener noreferrer" className="text-orange-400 hover:text-blue-800"> gmdb22 </a>
  •
  <a href="https://github.com/BNANMN" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-blue-800"> BNANMN </a>
  •
  <a href="https://github.com/altdespiritu" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:text-blue-800"> altdespiritu </a>
</p>
          <p className="text-xs text-gray-500">
            © 2025 Reika's Domain Egg Hunt
          </p>
            ...
            <div className="bg-gray-800 border border-green-500/30 rounded-lg p-6 relative">
              ...
              <ul className="text-base text-gray-300 space-y-4">
                <li className="flex flex-col gap-2">
                  <span className="text-green-500">• Type *'challenge N'* to see an overview of a specific challenge</span>
                  <img src="/AWSCCPCUFoundationDay/Quick Tip 1.gif" alt="Tip 1" className="w-full h-24 object-cover rounded" />
                </li>
                <li className="flex flex-col gap-2">
                  <span className="text-green-500">• Use *'hint N'* for challenge hints</span>
                  <img src="/AWSCCPCUFoundationDay/Quick Tip 2.gif" alt="Tip 2" className="w-full h-24 object-cover rounded" />
                </li>
                <li className="flex flex-col gap-2">
                  <span className="text-green-500">• *Eggs* need to be *upper case*</span>
                  <img src="/AWSCCPCUFoundationDay/Quick Tip 3.gif" alt="Tip 3" className="w-full h-24 object-cover rounded" />
                </li>
                <li className="flex flex-col gap-2">
                  <span className="text-green-500">• Don't be shy to use *hint* over and over again</span>
                  <img src="/AWSCCPCUFoundationDay/typing-monkey.gif" alt="Tip 4" className="w-full h-24 object-cover rounded" />
                </li>
              </ul>
            </div>
          </div>
