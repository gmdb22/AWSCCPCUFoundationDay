            ...
            <div className="bg-gray-800 border border-green-500/30 rounded-lg p-6 relative">
              ...
              <ul className="text-base text-gray-300 space-y-4">
                <li className="flex flex-col gap-2">
                  ...
                  <img src="/Quick Tip 1.gif" alt="Tip 1" className="w-full h-24 object-cover rounded" />
                </li>
                <li className="flex flex-col gap-2">
                  <span className="text-green-500">• Use *'hint N'* for challenge hints</span>
                  <img src="/Quick Tip 2.gif" alt="Tip 2" className="w-full h-24 object-cover rounded" />
                </li>
                <li className="flex flex-col gap-2">
                  <span className="text-green-500">• *Eggs* need to be *upper case*</span>
                  <img src="/Quick Tip 3.gif" alt="Tip 3" className="w-full h-24 object-cover rounded" />
                </li>
                <li className="flex flex-col gap-2">
                  <span className="text-green-500">• Don't be shy to use *hint* over and over again</span>
                  <img src="/typing-monkey.gif" alt="Tip 4" className="w-full h-24 object-cover rounded" />
                </li>
              </ul>
            </div>
          </div>
